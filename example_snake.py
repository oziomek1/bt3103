...
class Game():
	...
	def prepare_events(self):
		return [
			{'event_action': pg.K_LEFT,'event_result': self.snake.turn_left},
			{'event_action': pg.K_RIGHT,'event_result': self.snake.turn_right},
			{'event_action': pg.K_UP,'event_result': self.snake.turn_up},
			{'event_action': pg.K_DOWN,'event_result': self.snake.turn_down}
		]
